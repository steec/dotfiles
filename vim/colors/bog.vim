...
hi Normal guifg=#3a3a3d guibg=white ctermfg=darkgrey ctermbg=NONE
...
hi LineNr guifg=#3669e8 guibg=white ctermfg=lightblue ctermbg=NONE		
hi ModeMsg guifg=orange guibg=white ctermfg=lightred ctermbg=NONE		
hi MoreMsg guifg=orange guibg=white ctermfg=lightred ctermbg=NONE		
hi NonText gui=bold		
...
"hi SpecialKey	
hi StatusLine guifg=#04ae6c guibg=white ctermfg=darkgreen ctermbg=NONE
hi StatusLineNC guifg=#04ae6c guibg=white ctermfg=darkgreen ctermbg=NONE	
hi Title guifg=#02233f gui=bold	
hi Visual guifg=darkblue guibg=white ctermfg=darkblue ctermbg=NONE		
"hi VisualNOS	
...
hi Comment guifg=orange guibg=white ctermbg=NONE ctermfg=blue
hi Constant  guifg=#5b8f8d guibg=white ctermfg=grey ctermbg=NONE	
hi Identifier guifg=#aad2ff guibg=white ctermfg=grey ctermbg=NONE	
hi Statement guifg=#808283 guibg=white ctermfg=lightgrey ctermbg=NONE	
hi PreProc guifg=#023a6a gui=bold guibg=white ctermfg=darkblue ctermbg=NONE                                                                     
hi Type guifg=#0e9152 guibg=white ctermfg=darkgreen ctermbg=NONE		
hi Special guifg=white guibg=skyblue ctermfg=red ctermbg=NONE
