...
elseif &background == "light"
    if s:moria_style == "light"
        hi Normal ctermbg=NONE ctermfg=Black guibg=#eeeeee guifg=#000000 gui=none
    ...
    if s:moria_monochrome == 1
        hi FoldColumn ctermbg=NONE  guibg=bg guifg=#7a7a7a gui=none
        ...
        hi SignColumn ctermbg=NONE guibg=bg guifg=#7a7a7a gui=none
        ...
        hi FoldColumn ctermbg=NONE guibg=bg guifg=#375288 gui=none
        ...
        hi SignColumn ctermbg=NONE guibg=bg guifg=#375288 gui=none
